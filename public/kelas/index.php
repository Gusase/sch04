...
try {
  ...
  $query = "SELECT * from kelas AS kl JOIN gurus AS gr ON gr.kode_guru = kl.kode_guru";
...
<section class="container -mt-7 mx-auto bg-white dark:bg-gray-900 mt-14 ">
  <div class="flex-row items-center justify-between p-4 space-y-3 rounded-ss-lg dark:bg-gray-800 sm:flex sm:space-y-0 sm:space-x-4">
    <div>
      <h4 class="mr-3 text-2xl font-semibold dark:text-white">Semua kelas</h4>
      <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400"><?= $byk > 0 ? "Menampilkan $byk kelas" : 'Tidak ada data kelas'; ?></p>
    </div>
        ...
        while ($data = $datas->fetch_object()) : ?>
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td class="px-6 py-4 text-right">
              <a href="?v=mapel&i=<?= $data->id ?>&m=edit" class="text-white capitalize bg-[#404eed] hover:bg-blue-800/95 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-2 -ml-1" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  <path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V7z"></path>
                </svg>
                edit
                  ...
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-left">
                      <p class="text-base leading-relaxed text-gray-500 dark:text-gray-300">
                        Kamu akan menhapus pelajaran <b class="capitalize"><?= $data->nama; ?></b>, Anda yakin?
                      </p>
                    </div>
                    <!-- Modal footer -->
