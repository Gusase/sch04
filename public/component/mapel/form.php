          ...
          <div class="px-6 py-6 lg:px-8 space-y-4">
            ...
            <div>
              ...
              <div class="grid grid-cols-2 space-x-3">
                ...
                <!-- <input type="time" name="jam-akhir" id="j" placeholder="~" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required=""> -->
              </div>
            </div>
