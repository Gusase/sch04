...
if (!$id) {
  ...
  sleep(5);
  echo "<script>
          window.location.href='http://ev.final.test/?v=mapel'
        </script>";
}
        ...
        <div class="px-6 py-6 lg:px-8 space-y-4">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center pt-6 pb-3 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
              ...
              <button type="reset" onclick="window.location.href='https://ev.final.test/?v=mapel'" class="text-gray-500 uppercase bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">kembali</button>
            </div>
