    ...
    <form action="siswa/edit.php" method="post">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <div class="px-6 py-6 lg:px-8 space-y-4">
          <h3 class="mb-4 text-xl md:text-2xl font-medium text-gray-900 dark:text-white"><?= $data->nama_lengkap; ?> Data</h3>
          <div class="space-y-3">
            <div>
            ...
            <div>
              ...
              <input type="number" name="nomor" id="nomor" placeholder="~" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" fdprocessedid="ndtfi" value="<?= $data->telp ?>">
            </div>
            <div>
              ...
              <ul class="grid w-full gap-4 md:grid-cols-2">
                ...
                <li>
                  ...
                  <label for="perem" class="capitalize capitalize inline-flex justify-center items-center w-full p-3 md:p-4 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-600">
                    <div class="block">
            ...
            <div>
              ...
              <select id="jurs" name="jurusan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" fdprocessedid="yngzd">
                ...
                <option value="Otomotif" <?= ($data->jurusan == 'Otomotif') ? 'selected' : ''; ?>>otomotif</option>
              </select>
            </div>
